...
Feeds the `pr-review-assemble.mjs comment` meta (Step 8, item 5). ADO PR comments render `<details><summary>` collapsible blocks, but ONLY with a blank line after `</summary>` AND after `</details>` (the assembler always emits this format).
